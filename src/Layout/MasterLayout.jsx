  ...
  return (
    <>
      ...
      <div className="wrapper">
        {/*================  start top header  ================ */}
        <header
          className={`transition-all duration-500 mb-[60px] z-50 bg-white fixed left-0 right-0 top-0  ${
            isOpen ? " lg:ml-[70px]" : "lg:ml-[210px]"
          }`}
        >
